"""Test fixtures for the Upgrade Framework service.
...
(``aiios_upgrade_framework``), matching the project-wide convention of
one Postgres database per service rather than the shared bootstrap
database referenced in the root ``.env``.
"""
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_upgrade_framework")
...
os.environ.setdefault("AIIOS_REDIS_DB", "49")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_upgrade_framework_service_test_keys"
...
os.environ.setdefault(
    "AIIOS_UPGRADE_FRAMEWORK_SERVICE_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_UPGRADE_FRAMEWORK_SERVICE_WORKERS_ENABLED", "false")
...
def postgres_test_settings() -> DatabaseSettings:
    return DatabaseSettings(
        ...
        database_port=5433,
        database_name="aiios_upgrade_framework",
        database_user="aiios",
...
def redis_test_settings() -> RedisSettings:
    """Test db 49 -- this service's own, distinct from every other."""
