"""Rollback path validation, built on ``app.compatibility.engine``'s
...
def can_rollback_to(
    *, current_version: str, target_version: str, available_versions: Iterable[str]
    ...
    actually seen released before -- rollback restores a previously
    known-good state, it never jumps to an arbitrary or newer
    version."""
