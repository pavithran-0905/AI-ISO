...
shared server, not one per service) but each owns its own database --
see ``services/observability-platform-service/alembic/env.py``, where
this defence was found to matter for real after a migration ran against
...
VERSION_TABLE = "alembic_version_multi_cluster_management_service"
