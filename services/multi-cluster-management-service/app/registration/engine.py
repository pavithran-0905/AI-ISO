...
time this service actually tries to reach the cluster turns a
...
def validate_credential(
    ...
    The actual secret this reference points to is never seen or
    validated here -- that is secrets-management-service's job. This
