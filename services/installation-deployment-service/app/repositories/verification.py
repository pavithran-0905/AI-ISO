"""Repository for post-install/post-upgrade verification results."""
...
class VerificationResultRepository(BaseRepository[VerificationResult]):
    ...
    async def list_for_job(self, deployment_job_id: UUID) -> Sequence[VerificationResult]:
        stmt = self._base_select().where(VerificationResult.deployment_job_id == deployment_job_id)
