"""Test fixtures for the Installation & Deployment service.
...
(``aiios_installation_deployment``), matching the project-wide
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_installation_deployment")
...
os.environ.setdefault("AIIOS_REDIS_DB", "48")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_installation_deployment_service_test_keys"
...
os.environ.setdefault(
    "AIIOS_INSTALLATION_DEPLOYMENT_SERVICE_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_INSTALLATION_DEPLOYMENT_SERVICE_WORKERS_ENABLED", "false")
...
def postgres_test_settings() -> DatabaseSettings:
    return DatabaseSettings(
        ...
        database_port=5433,
        database_name="aiios_installation_deployment",
        database_user="aiios",
...
def redis_test_settings() -> RedisSettings:
    """Test db 48 -- this service's own, distinct from every other."""
