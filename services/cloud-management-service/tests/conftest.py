"""Test fixtures for the cloud management service.
...
**Uses the service's own dedicated database** (``aiios_cloud``), matching
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_cloud")
...
os.environ.setdefault("AIIOS_REDIS_DB", "41")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_cloud_management_service_test_keys"
...
os.environ.setdefault(
    "AIIOS_CLOUD_MANAGEMENT_SERVICE_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_CLOUD_MANAGEMENT_SERVICE_WORKERS_ENABLED", "false")
...
def redis_test_settings() -> RedisSettings:
    """Test db 41 -- this service's own, distinct from every other."""
