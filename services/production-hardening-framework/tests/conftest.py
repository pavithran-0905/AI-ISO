"""Test fixtures for the Production Hardening Framework.
...
(``aiios_production_hardening_framework``), matching the project-wide
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_production_hardening_framework")
...
os.environ.setdefault("AIIOS_REDIS_DB", "52")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_production_hardening_framework_test_keys"
...
os.environ.setdefault(
    "AIIOS_PRODUCTION_HARDENING_FRAMEWORK_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_PRODUCTION_HARDENING_FRAMEWORK_WORKERS_ENABLED", "false")
...
def postgres_test_settings() -> DatabaseSettings:
    return DatabaseSettings(
        ...
        database_port=5433,
        database_name="aiios_production_hardening_framework",
        database_user="aiios",
...
def redis_test_settings() -> RedisSettings:
    """Test db 52 -- this service's own, distinct from every other."""
