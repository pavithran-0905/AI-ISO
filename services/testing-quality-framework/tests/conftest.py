"""Test fixtures for the Testing & Quality Assurance Framework.
...
(``aiios_testing_quality_framework``), matching the project-wide
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_testing_quality_framework")
...
os.environ.setdefault("AIIOS_REDIS_DB", "50")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_testing_quality_framework_test_keys"
...
os.environ.setdefault(
    "AIIOS_TESTING_QUALITY_FRAMEWORK_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_TESTING_QUALITY_FRAMEWORK_WORKERS_ENABLED", "false")
...
def postgres_test_settings() -> DatabaseSettings:
    return DatabaseSettings(
        ...
        database_port=5433,
        database_name="aiios_testing_quality_framework",
        database_user="aiios",
...
def redis_test_settings() -> RedisSettings:
    """Test db 50 -- this service's own, distinct from every other."""
