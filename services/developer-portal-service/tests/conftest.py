"""Test fixtures for the Developer Portal service.
...
**Uses the service's own dedicated database** (``aiios_developer_portal``),
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_developer_portal")
...
os.environ.setdefault("AIIOS_REDIS_DB", "47")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_developer_portal_service_test_keys"
...
os.environ.setdefault(
    "AIIOS_DEVELOPER_PORTAL_SERVICE_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_DEVELOPER_PORTAL_SERVICE_WORKERS_ENABLED", "false")
...
def postgres_test_settings() -> DatabaseSettings:
    return DatabaseSettings(
        ...
        database_port=5433,
        database_name="aiios_developer_portal",
        database_user="aiios",
...
def redis_test_settings() -> RedisSettings:
    """Test db 47 -- this service's own, distinct from every other."""
