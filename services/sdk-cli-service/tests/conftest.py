"""Test fixtures for the SDK & CLI service.
...
**Uses the service's own dedicated database** (``aiios_sdk_cli``), matching
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_sdk_cli")
...
os.environ.setdefault("AIIOS_REDIS_DB", "44")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_sdk_cli_service_test_keys"
...
os.environ.setdefault("AIIOS_SDK_CLI_SERVICE_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH))
os.environ.setdefault("AIIOS_SDK_CLI_SERVICE_WORKERS_ENABLED", "false")
...
def redis_test_settings() -> RedisSettings:
    """Test db 44 -- this service's own, distinct from every other."""
