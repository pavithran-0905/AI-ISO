"""Test fixtures for the administration portal service.
...
**Uses the service's own dedicated database** (``aiios_admin``), matching
...
os.environ.setdefault("AIIOS_DATABASE_NAME", "aiios_admin")
...
os.environ.setdefault("AIIOS_REDIS_DB", "43")
...
_TEST_KEY_DIR = Path(tempfile.gettempdir()) / "aiios_administration_portal_service_test_keys"
...
os.environ.setdefault(
    "AIIOS_ADMINISTRATION_PORTAL_SERVICE_JWT_PUBLIC_KEY_PATH", str(_TEST_PUBLIC_KEY_PATH)
)
os.environ.setdefault("AIIOS_ADMINISTRATION_PORTAL_SERVICE_WORKERS_ENABLED", "false")
...
def redis_test_settings() -> RedisSettings:
    """Test db 43 -- this service's own, distinct from every other."""
