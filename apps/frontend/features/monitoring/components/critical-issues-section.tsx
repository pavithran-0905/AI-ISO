 ...
 * newest-updated first) rather than the full dataset, per §15's "used
 * only for appropriately sized data." */
const SCAN_PAGE_SIZE = 100;

/**
 * Critical Issues (§4, Overview Level 3 — "what requires
 * investigation") — assets whose `health` is `critical` or
 * `unreachable`, from the most recently updated page of results.
 */
    ...
    <div className="flex flex-col gap-2">
      ...
      {truncated && (
        <p className="text-muted-foreground text-xs">
          ...
          <Link href="/monitoring/assets" className="underline">
            Assets
          </Link>{" "}
